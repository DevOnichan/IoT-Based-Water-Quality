...
**สําคัญ : ในระบบ IoT เดิมมีแนวคิดส่งข้อมูลจากอุปกรณ์ไปยัง Google Sheet โดยตรงผ่าน HTTPS แต่พบว่าการเชื่อมต่อจาก MicroController มีโอกาสเกิดปัญหา เช่น การ handshake ของ SSL/TLS ใช้ทรัพยากรสูง ทำให้บางครั้งส่งข้อมูลไม่สำเร็จหรือหลุดระหว่างทาง จึงปรับสถาปัตยกรรมระบบใหม่ โดยให้อุปกรณ์ส่งข้อมูลผ่าน HTTP ไปยัง Blynk ก่อน เนื่องจากมีความเสถียรและเหมาะกับอุปกรณ์ IoT มากกว่า จากนั้นใช้ Google Apps Script ดึงข้อมูลจาก Blynk API มาเก็บลง Google Sheet แทน**
